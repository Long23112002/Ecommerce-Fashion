...
public interface NotificationService {
    ...
    void sendNotificationToUser(Long createBy, Long idReceiver, NotificationCode notificationCode, String... variables);
    void sendNotificationToUser(Long idReceiver, NotificationCode notificationCode, String... variables);
