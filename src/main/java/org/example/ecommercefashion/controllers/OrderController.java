...
public class OrderController {
  ...
  public OrderResponse updateAdress(
      @PathVariable Long id, @Valid @RequestBody OrderAddressUpdate orderAddressUpdate) {
    return orderService.updateAddress(id, orderAddressUpdate);
  }

  @PutMapping("/update-discount/{id}")
  public OrderResponse updateDiscount(@PathVariable Long id, @RequestParam Long discountId) {
    return orderService.updateDiscount(id, discountId);
  }

  @PutMapping("/payment/{id}")
  public String orderUpdateAndPay(
      @PathVariable Long id, @Valid @RequestBody OrderUpdateRequest orderUpdateRequest)
