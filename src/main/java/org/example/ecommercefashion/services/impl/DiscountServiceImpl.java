...
public class DiscountServiceImpl implements DiscountService {
    ...
    @Override
    public ResponsePage<Discount, DiscountResponse> filterDiscount(Long keyword,Pageable pageable) {
        Page<Discount> discountResponsesPage = discountRepository.getDiscountPage(keyword,pageable);
