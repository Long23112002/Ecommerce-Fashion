...
import org.example.ecommercefashion.dtos.request.TemplateUpdateRequest;
...
public class TemplateController {
    ...
    @PutMapping("/{id}")
    private TemplateResponse updateTemplate(@PathVariable Long id, @Valid @RequestBody TemplateUpdateRequest request){
